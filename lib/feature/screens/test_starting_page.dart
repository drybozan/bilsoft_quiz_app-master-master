...
import 'package:bilsoft_quiz_app/feature/widgets/test_starting_body.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class TestStartPage extends StatelessWidget {
  const TestStartPage({ Key? key }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:TestStartingBody(topicName: "Üçgenler",)
